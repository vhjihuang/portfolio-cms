...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    colorFrom: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'"cyan-500"'>;
    colorTo: Schema.Attribute.String & Schema.Attribute.DefaultTo<'"blue-500"'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    iconName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'"desktop", "mobile", "design"'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::service.service'
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tag: Schema.Attribute.Relation<
      'manyToMany',
      'api::technical-note.technical-note'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTechnicalNoteTechnicalNote
  extends Struct.CollectionTypeSchema {
  collectionName: 'technical_notes';
  info: {
    displayName: 'TechnicalNote';
    pluralName: 'technical-notes';
    singularName: 'technical-note';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::technical-note.technical-note': ApiTechnicalNoteTechnicalNote;
